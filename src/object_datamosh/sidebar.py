...
def draw_sidebar(
    ...
    *,
    ...
    feedback.label(text="The effect mask controls where feedback appears.")
    feedback.label(text="An object on the first/reset frame seeds its clean image.")
    feedback.label(text="A background-only pre-roll enables a more corrupted entrance.")
